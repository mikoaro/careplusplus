import { HistoricalEvent } from "@/components/Map";
...
const eventsData: HistoricalEvent[] = [
  // War
  {
    ...
    position: [41.9029, 12.4545], // Austin, TX
    category: "Art",
    name: "Miriam Aupont",
    titlec: "Therapist",
    phonec: "512-244-3672",
    mobilephonec: "512-244-3672",
    "picturec": "https://s3-us-west-2.amazonaws.com/dev-or-devrl-s3-bucket/sample-apps/people/miriam_aupont.jpg",
  },
  // Art
  {
    id: 2,
  ...
  {
    id: 78,
    title: "Austin Therapy | Miriam Aupont",
    description:
      "Mental health service in Austin, Texas.",
    position: [30.4378447,-97.8052257], // Austin, TX
    category: "Therapy",
    name: "Miriam Aupont",
    titlec: "Therapist",
    phonec: "512-244-3672",
  ...
  {
    id: 79,
    title: "ATX Counseling | Michael Jones",
    description:
      "Counseling service in Austin, Texas.",
    position: [30.3892877, -97.6551937], // Austin, TX
    category: "Psychologist",
    name: "Michael Jones",
    titlec: "Psychologist",
    phonec: "512-284-7672",
    mobilephonec: "512-284-7672",
    "picturec": "https://s3-us-west-2.amazonaws.com/dev-or-devrl-s3-bucket/sample-apps/people/michael_jones.jpg",
  },
];
